 ...
 */
package com.tc.website.modules.gen.util;
...
import com.tc.website.common.mapper.JaxbMapper;
import com.tc.website.common.utils.DateUtils;
import com.tc.website.common.utils.FileUtils;
import com.tc.website.common.utils.FreeMarkers;
import com.tc.website.common.utils.StringUtils;
import com.tc.website.modules.gen.entity.GenConfig;
import com.tc.website.modules.gen.entity.GenTable;
...
import com.tc.website.common.utils.FreeMarkers;
import com.tc.website.common.utils.StringUtils;
import com.tc.website.modules.gen.entity.GenCategory;
import com.tc.website.modules.gen.entity.GenConfig;
import com.tc.website.modules.gen.entity.GenScheme;
import com.tc.website.modules.gen.entity.GenTable;
import com.tc.website.modules.gen.entity.GenTableColumn;
import com.tc.website.modules.gen.entity.GenTemplate;
	...
	public static void initColumnField(GenTable genTable){
		for (GenTableColumn column : genTable.getColumnList()){
			...
			if (StringUtils.startsWithIgnoreCase(column.getJdbcType(), "CHAR")
				...
				column.setJavaType("java.utils.Date");
		...
		try{
			...
			if(file != null){
				return file.getAbsolutePath() + File.separator + StringUtils.replaceEach(GenUtils.class.getName(), 
						new String[]{"utils."+GenUtils.class.getSimpleName(), "."}, new String[]{"template", File.separator});
			}			
		}catch(Exception e){
			logger.error("{}", e);
		}
